...
contract HelperConfig{
    ...
    function getArbitrumMainnetNetworkConfig() public pure returns(NetworkConfig memory){
        return NetworkConfig({
           entryPoint: 0x0000000071727De22E5E9d8BAf0edAc6f37da032,
            account: BURNER_WALLET
        });
    ...
    function getZkSyncMainnetNetworkConfig() public pure returns(NetworkConfig memory){
        return NetworkConfig({
    ...
    function getorCreateNetworkConfig() public view returns(NetworkConfig memory){
